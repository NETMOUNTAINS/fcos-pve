...
COREOS_FILES_PATH=/etc/pve/netmountains-pve/coreos
...
then
	...
	echo -e "# This file is managed by NETMOUNTAINS hook-script. Do not edit.\n" > ${COREOS_FILES_PATH}/${vmid}.yaml
	...
	echo "      gecos: \"NETMOUNTAINS CoreOS Administrator\"" >> ${COREOS_FILES_PATH}/${vmid}.yaml
